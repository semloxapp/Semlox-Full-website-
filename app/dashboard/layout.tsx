  ...
  return (
    <div className="dashboard-header fixed left-0 right-0 top-0 z-[200] flex h-[50px] items-center justify-between border-b border-white/[0.08] bg-[#070B17] pr-5 text-white">
      <div className="flex h-full items-center">
        <div className="dashboard-header-brand flex h-full w-[220px] items-center gap-2 border-r border-white/[0.06] px-5">
...
function Sidebar() {
  ...
  return (
    <aside className="dashboard-sidebar flex h-full min-h-0 w-[220px] shrink-0 flex-col border-r border-white/[0.06] bg-[#070B17] px-2 py-3 text-white">
      ...
      <div className="dashboard-sidebar-divider mt-3 border-t border-white/[0.06] pt-2">
      ...
      <div className="dashboard-sidebar-divider mt-4 border-t border-white/[0.06] pt-3">
        <div className="dashboard-sidebar-label mb-2 px-2 text-[9px] font-semibold uppercase tracking-[0.18em] text-[#334155]">
          Support
        </div>
      ...
      <Link href="/logout" className="dashboard-support-link mt-auto mb-3 flex h-[34px] items-center gap-2.5 rounded-[6px] px-3 text-[12.5px] font-medium text-[#6F86AA] hover:bg-white/[0.03]">
